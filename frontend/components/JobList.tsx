    ...
    return (
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 text-base">Loading your analysis jobs...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 border border-slate-200">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3">
        <div className="flex items-center">
          <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-indigo-600 rounded flex items-center justify-center mr-2">
            <span className="text-white text-sm">📋</span>
          </div>
          <div>
            <h2 className="text-lg font-bold text-slate-800">Your Analysis Jobs</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
          <div className="relative w-full md:w-48">
            ...
            />
            <svg className="absolute right-2 top-1.5 h-4 w-4 text-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      ...
      {jobs.length === 0 ? (
        <div className="text-center py-8">
          <div className="w-16 h-16 bg-gradient-to-br from-slate-100 via-blue-100 to-indigo-100 rounded-xl flex items-center justify-center mx-auto mb-4">
            <span className="text-2xl">🚀</span>
          </div>
          <h3 className="text-base font-bold text-slate-800 mb-2">No Analysis Jobs Yet</h3>
          <p className="text-slate-600 text-sm max-w-xs mx-auto">
            Submit your first text for AI analysis to get started.
          </p>
        </div>
      ) : (
        <div>
